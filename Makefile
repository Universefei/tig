...
EXE	= tig
TOOLS	= tools/test-graph tools/doc-gen
...
TIG_OBJS = tig.o util.o io.o graph.o refs.o request.o line.o keys.o repo.o options.o util.o draw.o $(COMPAT_OBJS)
tig: $(TIG_OBJS)

TEST_GRAPH_OBJS = tools/test-graph.o util.o io.o graph.o
tools/test-graph: $(TEST_GRAPH_OBJS)

DOC_GEN_OBJS = tools/doc-gen.o request.o util.o
